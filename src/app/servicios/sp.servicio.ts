...
export class SPServicio {
    ...
    public ObtenerConfiguracionConPost() {
        ...
        const configuracionSharepoint = pnp.sp.configure({
            headers: {
                ...
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6Ik4tbEMwbi05REFMcXdodUhZbkhRNjNHZUNYYyIsImtpZCI6Ik4tbEMwbi05REFMcXdodUhZbkhRNjNHZUNYYyJ9..f8N4ogfOWDNpMWXQK_2BoRl7oCn60BiFs-D6Wmo-IOwdBZq6o4OK6uno91XP9V9DlxAjJU7-8_LvI3qgDAX2Z6DqPb4MGvLcu4RT5oiks2igf51Lxda5W9UfD0cFzf-tjBhyBQ0vaD-ktYFxRc50CPVUZDoVnU8HP8t9GzmAZM8BBjJ8YnmqDw6iOHEUGJFsJDW8Iyuv5-fUEar13FaiKOVq-y-81NuTW5rvXULXridORANoy33mlEyZqgwxyX6_8qq9F7dnMRmuz_LlONeaiBspcjEIAr09ACPaf0wz4JwMDi8T5BaQMYerY-8E8qaF1Q2PaxW2TjEjnPhVmQqiIQ'
            }
        }, environment.urlWeb);
    ...
    ObtenerInformacionSitio() {
        let respuesta = from(this.ObtenerConfiguracionConPost().web.get());
        return respuesta;
    }
    ...
    public async obtenerUsuarioActualPromesa(): Promise<any> {
        return await from(this.ObtenerConfiguracionConPost().web.currentUser.get()).toPromise();
    }
